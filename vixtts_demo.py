...
def normalize_vietnamese_text(text):
    ...
    # Thực hiện chuẩn hóa với TTSnorm
    text = (
...
if __name__ == "__main__":
    ...
    # REFERENCE_AUDIO = "/home/niran/Documents/GitHub/vixtts-demo/voice/mixi_2.wav"
    REFERENCE_AUDIO = os.path.join(SCRIPT_DIR, "voice", "mixi_2.wav")
    ...
    with gr.Blocks() as demo:
        ...
        with gr.Row():
            ...
            with gr.Column() as col2:
                ...
                tts_text = gr.Textbox(
                    label="Input Text.",
                    value="Ngày xưa, tại một ngôi làng nhỏ nằm bên dòng sông xanh, có một cô bé tên Linh. Cô bé rất yêu thiên nhiên và thường dành cả buổi chiều ngồi dưới gốc cây đa lớn để đọc sách. Một ngày nọ, Linh tìm thấy một cuốn sách cũ kỹ với những câu chuyện kỳ diệu về thế giới cổ tích. Từ đó, cô bắt đầu mơ ước trở thành một nhà văn để sáng tạo ra những câu chuyện của riêng mình, mang niềm vui và hy vọng đến cho mọi người.",
                )
        ...
        # load_model(checkpoint_dir, repo_id, use_deepspeed)
